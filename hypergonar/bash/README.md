# [Hypergonar](../README.md) bash scripts
...
- [fal](fal/README.md)
- [luma](luma/README.md)
- [livePortrait](livePortrait/README.md)
...
- AWS_ACCESS_KEY_ID: Amazon S3 key id

- AWS_SECRET_ACCESS_KEY: Amazon S3 key secret

- AWS_DEFAULT_REGION: Amazon S3 region (eu-west-1)
